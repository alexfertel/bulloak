...
pub fn scaffold(text: &str, with_comments: bool, indent: usize, solidity_version: &str) -> error::Result<Compiled> {
    ...
    let emitted = emitter::Emitter::new(with_comments, indent, solidity_version.to_string()).emit(&ast, modifiers);
